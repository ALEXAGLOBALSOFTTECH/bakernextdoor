<div class="modal fade" id="closenotice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <p><?php echo display('closed_msg'); ?> 
				<?php echo $this->settinginfo->opentime; ?>- <?php echo $this->settinginfo->closetime; ?></p>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 team_slider owl-carousel">
                        ...
                        <div class="single-team-member text-center">
                            <div class="team-member-img "  style="width:55%;">
                          <img src="http://stratsutra.com/bakernextdoor/application/modules/itemmanage/assets/images/small/tatler.jpg" alt="">
                            </div>   
                        </div>
					<div class="single-team-member text-center">
                            <div class="team-member-img "  style="width:55%;">
                          <img src="http://stratsutra.com/bakernextdoor/application/modules/itemmanage/assets/images/small/edkl.jpg" alt="">
                            </div>   
                        </div>
					<div class="single-team-member text-center">
                            <div class="team-member-img " style="width:55%;">
                          <img src="http://stratsutra.com/bakernextdoor/application/modules/itemmanage/assets/images/small/popdaily.jpg" alt="">
                            </div>   
                        </div>
					<div class="single-team-member text-center">
                            <div class="team-member-img"  style="width:55%;">
                          <img src="http://stratsutra.com/bakernextdoor/application/modules/itemmanage/assets/images/small/buro.jpg" alt="">
                            </div>   
                        </div>
