             ...
             <div class="col-xl-9 col-md-8">
                 <div class="col-sm-12 col-md-12 rating-block myinfotable">
                     ...
                     <table class="table table-hover" width="100%">
                         <tbody>
                             <tr>
                                 <th><a class="btn btn-success btn-sm search profile_fff" data-toggle="modal" data-target="#updatep" data-dismiss="modal" style="color:#fff;"><strong><?php echo display('profile_update')?></strong></a></th>
                                 <td></td>
                             </tr>
                             <tr>
