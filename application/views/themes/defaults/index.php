					...
					<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
						<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
							...
							foreach ($allmenu as $menu) {
								...
								if ($submenu->menu_slug == 'hungry/logout') {
					...
					<div class="col-lg-4">
						<div class="footer-logo-area mb-5 mb-lg-0">
							<div class="footer-logo">
								<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(!empty($webinfo->logo_footer) ? $webinfo->logo_footer : 'dummyimage/168x65.jpg'); ?>" alt="footer logo"></a>
							</div>
