                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <?php } ?>
                                        <a class="btn btn-success btn-sm search text-white" onclick="logincustomer();"><?php echo display('login') ?></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone" class="form-control" value="<?php echo (!empty($billinginfo->phone) ? $billinginfo->phone : null) ?>" placeholder="Add Contact number" name="phone" required>
                                    </div>
                                </div>
                            </div>
                        </div>
