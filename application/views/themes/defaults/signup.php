                    ...
                    <?php } ?>
                                    ...
                                    <div class="rrtt">
                                      <?php echo form_open_multipart('hungry/submitregister','class="row"') ?>
                                        ...
                                        <div class="col-sm-12">
                                            <input type="submit" class="btn btn-success btn-sm search" value="Register Now">&nbsp; OR &nbsp;<a href="<?php echo base_url().'mylogin'?>" class="btn btn-success btn-sm search">Login</a>
                                        </div>
                                        <?php echo form_close() ?>
