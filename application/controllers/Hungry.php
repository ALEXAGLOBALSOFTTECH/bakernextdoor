...
class Hungry extends CI_Controller
{
	...
	public $sociallink = '';
	public $themeinfo = '';
	public $appKey =  'pk_test_ca7146e4d1a9e191f3e0e65a38952353';
	public $appSecret ='sk_test_mrcx89oNps1XSuGO3yT267VM4Eh+y/Uc9lKKqJ59OWqf7P1KzU2PpO7nClxhE9vY';
	...
	public function index()
	{
		...
		$data['title2'] = "Welcome to Bakernextdoor";
		$data['seoterm'] = "home";
	...
	public function submitregister()
	{
        ...
        /* email*/ 
		 ...
		 $this->load->library('parser'); /* to avoid SPAM */
			...
			$body = $this->load->view('themes/defaults/email_templates/welcome_email.php',$indata,TRUE);
			
			$this->email->from($send_email->sender, 'Baker Next Door');
			$this->email->to($this->input->post('user_email'));
			$this->email->subject('Welcome to Baker Next Door');
	...
	public function userlogin()
	{
		...
		if ($cek > 0) {
			...
			if (!empty($getcus)) {
				...
				$myname	= $this->session->userdata('cusfname');
				echo  "success";
  ...
  function payWithPaystack(){
	...
	public function subscribe()
	{
		...
		if (empty($exitsemail)) {
			...
			$this->email->from($send_email->sender, 'Bakernextdoor');
...
public function mediaCoverage()
	{
		...
		$data['seoterm'] = "bakernext door in media";
		$this->load->view('themes/' . $this->themeinfo->themename . '/media_coverage',$data);
	}
	...
	public function fwritetxt(){
		...
		/* public function mediaCoverage()
			{
				//$this->load->view('themes/' . $this->themeinfo->themename . '/media_coverage');
			echo 'cover';
			$this->load->view('themes/defaults/media_coverage')
			} */
