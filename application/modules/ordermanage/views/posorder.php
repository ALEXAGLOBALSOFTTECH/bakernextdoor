                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="product-category">
                          ...
                          <div class="listcat dropdown cat-nav">                          		
								<button class="btn dropdown-toggle listcat listcat2" type="button" data-toggle="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu dropcat">
                                                                                ...
                                                                                <li><a onclick="getslcategory(<?php echo $subcat->CategoryID;?>)"><?php echo $subcat->Name;?></a></li>
                                                                                <?php } ?>
                                                                            </ul>
						  ...
						  <div class="listcat dropdown cat-nav" onclick="getslcategory(<?php echo $category->CategoryID;?>)"><?php echo $category->Name;?></div>
						  <?php  } } ?>
